...
window.SD_COMPONENTS.renderMonsterCard = function(m, isPinned = false) {
  ...
  card.innerHTML = `
    ...
    <div class="card-body">
      ...
      <p class="monster-description">${m.desc}</p>
      
      <div class="hp-tracker">
        <div class="armor-class" aria-label="Clase de Armadura ${m.ca}">
          <span>CA</span>
          <strong>${m.ca}</strong>
        </div>
      ...
      <div class="card-field">
        <div class="monster-attacks-heading">
          <label>Ataques</label>
          <span class="monster-move">MV: ${m.mv}</span>
        </div>
